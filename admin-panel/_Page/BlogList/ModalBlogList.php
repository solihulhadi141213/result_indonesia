                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-8 mb-2">
                             <select name="OrderBy" id="OrderBy" class="form-control">
                                ...
                                <option value="title_blog">Judul</option>
                                <option value="datetime_creat">Tanggal</option>
                                <option value="author_blog">Penulis</option>
            ...
            <form action="javascript:void(0);" id="ProsesTambah">
                <div class="modal-header">
                    <h5 class="modal-title text-dark">
                        <i class="bi bi-plus"></i> Posting Blog
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row mb-2">
                        <div class="col-md-12">
                            <label for="title_blog">Judul Posting</label>
                            <input type="text" name="title_blog" id="title_blog" class="form-control">
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-md-12">
                            <label for="tag">Label/Tag</label>
                    ...
                    <div class="row mb-2">
                        <div class="col-md-6">
                            <label for="author_blog">Penulis/Author</label>
                            <input type="text" name="author_blog" id="author_blog" class="form-control" value="<?php echo $SessionNama; ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="publish">Publis/Draft</label>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <form action="javascript:void(0);" id="ProsesHapus">
                <input type="hidden" name="id_blog" id="id_blog_hapus">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="javascript:void(0);" id="ProsesTambahKonten">
                <input type="hidden" name="id_blog" id="id_blog_tambah_konten" value="">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="javascript:void(0);" id="ProsesEditContent">
                <div class="modal-header">
                    <h5 class="modal-title text-dark">
                        <i class="bi bi-pencil"></i> Edit Konten Blog
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <form action="javascript:void(0);" id="ProsesHapusContent">
                <input type="hidden" name="id_blog" id="id_blog_delete">

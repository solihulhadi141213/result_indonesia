<?php
    ...
    // Ambil dan filter list kontak
    $kontakList = $data['kontak']['list'] ?? [];
    $filteredList = array_values(array_filter($kontakList, function($item) use ($orderToDelete) {
    ...
    echo json_encode([
        'status' => true,
        'message' => 'Kontak dengan order ' . $orderToDelete . ' berhasil dihapus dan disusun ulang',
        'data' => $filteredList
    ]);
?>
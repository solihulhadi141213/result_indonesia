<?php
    ...
    if (!$newValue) {
        http_response_code(400);
        echo json_encode(['status' => false, 'message' => 'Parameter "value" tidak boleh kosong']);
        exit;
    }
    ...
    // Update title dan value alamat
    $data['alamat']['title'] = $newTitle;
    $data['alamat']['value'] = $newValue;
